      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground mb-12 text-center">
            Get notified about new resources, spiritual insights, and community
            events
          </p>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    ...
                    <span className="text-sm">New Resources</span>
                  </label>
                  <label className="flex items-center">
                    <input type="checkbox" className="mr-2" />
                    <span className="text-sm">Weekly Devotionals</span>
                  </label>
                  <label className="flex items-center">
                    <input type="checkbox" className="mr-2" />
          ...
          <div className="mt-12 text-center">
            <p className="text-muted-foreground mb-4">
              By subscribing, you agree to receive updates from Dunamis Faith
              Hub
            </p>
